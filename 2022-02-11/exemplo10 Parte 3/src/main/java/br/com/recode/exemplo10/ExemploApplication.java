...
public class ExemploApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		venda4.setCliente(cliente2);
		venda5.setCliente(cliente3);
		
		cliente1.getVendas().addAll(Arrays.asList(venda1));
		cliente2.getVendas().addAll(Arrays.asList(venda2,venda4));
		cliente1.getVendas().addAll(Arrays.asList(venda3,venda5));
